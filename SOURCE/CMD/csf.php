...
/*
* TMSiaB "csf_rcp_xml.php" ( Create Server Files for RCP )
* v5.0
*/
...
if( $dplugin == 'LIVE' ) {
$config_file = str_replace('DSN1', 'mysql:dbname=remotecp;host=localhost:8080', $config_file);
}
else {
	if( $dplugin == 'MASECO' ) {
	$config_file = str_replace('DSN1', 'mysql:dbname=maseco;host=localhost:8080', $config_file);
	}
	else {
		if( $dplugin == 'XASECO' ) {
		$config_file = str_replace('DSN1', 'mysql:dbname=xaseco;host=localhost:8080', $config_file);
		}
		else {
		$config_file = str_replace('DSN1', 'mysql:dbname=remotecp;host=localhost:8080', $config_file);
...
if( $dplugin == 'LIVE' ) {
$config_file = str_replace('DSN2', 'mysql:dbname=remotecp;host=localhost:8080', $config_file);
}
else {
	if( $dplugin == 'MASECO' ) {
	$config_file = str_replace('DSN2', 'mysql:dbname=maseco;host=localhost:8080', $config_file);
	}
	else {
		if( $dplugin == 'XASECO' ) {
		$config_file = str_replace('DSN2', 'mysql:dbname=xaseco;host=localhost:8080', $config_file);
		}
		else {
		$config_file = str_replace('DSN2', 'mysql:dbname=remotecp;host=localhost:8080', $config_file);
		$config_file = str_replace('true', 'false', $config_file);
...
if( $dplugin == 'LIVE' ) {
$config_file = str_replace('DSN3', 'mysql:dbname=remotecp;host=localhost:8080', $config_file);
}
else {
	if( $dplugin == 'MASECO' ) {
	$config_file = str_replace('DSN3', 'mysql:dbname=maseco;host=localhost:8080', $config_file);
	}
	else {
		if( $dplugin == 'XASECO' ) {
		$config_file = str_replace('DSN3', 'mysql:dbname=xaseco;host=localhost:8080', $config_file);
		}
		else {
		$config_file = str_replace('DSN3', 'mysql:dbname=remotecp;host=localhost:8080', $config_file);
		$config_file = str_replace('true', 'false', $config_file);
