...
function ml_popupUpdatePopupXml($login,$action='show',$popup_id=true){
	...
	$popup_title = (isset($popups[$popup_id]['TitleLocale']) && $popups[$popup_id]['TitleLocale']!='') ? htmlspecialchars(localeText($login,$popups[$popup_id]['TitleLocale'])) : ((isset($popups[$popup_id]['Title']) && $popups[$popup_id]['Title']!='') ? htmlspecialchars($popups[$popup_id]['Title']) : '');
	$popup_text = (isset($popups[$popup_id]['TextLocale']) && $popups[$popup_id]['TextLocale']!='') ? htmlspecialchars(localeText($login,$popups[$popup_id]['TextLocale'])) : ((isset($popups[$popup_id]['Text']) && $popups[$popup_id]['Text']!='') ? htmlspecialchars($popups[$popup_id]['Text']) : '');
	$popup_button = (isset($popups[$popup_id]['ButtonLocale']) && $popups[$popup_id]['ButtonLocale']!='') ? htmlspecialchars(localeText($login,$popups[$popup_id]['ButtonLocale'])) : ( (isset($popups[$popup_id]['Button']) && $popups[$popup_id]['Button']!='') ? htmlspecialchars($popups[$popup_id]['Button']) :  'OK' );
	$popup_button_ml = (isset($popups[$popup_id]['ML']) && $popups[$popup_id]['ML']!='') ? "manialink='".htmlspecialchars($popups[$popup_id]['ML'])."'" : '';
	$popup_button_url = (isset($popups[$popup_id]['Url']) && $popups[$popup_id]['Url']!='') ? "url='".htmlspecialchars($popups[$popup_id]['Url'])."'" : '';
