...
/*
		...
		mysql_query($sql);
		$sql = 'DELETE FROM rs_times WHERE NOT EXISTS (SELECT id FROM players p WHERE p.id=rs_times.playerID)';
		mysql_query($sql);
		$sql = 'DELETE FROM rs_times WHERE NOT EXISTS (SELECT id FROM challenges c WHERE c.id=rs_times.challengeID)';
		mysql_query($sql);
*/
