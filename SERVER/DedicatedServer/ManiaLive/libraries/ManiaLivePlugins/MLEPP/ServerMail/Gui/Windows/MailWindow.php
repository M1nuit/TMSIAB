...
use ManiaLivePlugins\MLEPP\ServerMail\Gui\Controls\Header;
use ManiaLivePlugins\MLEPP\ServerMail\Gui\Controls\Normal;
use ManiaLivePlugins\MLEPP\ServerMail\Gui\Controls\Action;
...
class MailWindow extends \ManiaLive\Gui\Windowing\ManagedWindow
{
	//components ...
	private $navigator;
	private $table;
	...
	function initializeComponents()
	{
		...
		$this->setTitle('Server Mail - Your mailbox');
		$this->setMaximizable();
...
$this->page_items = floor( ($this->table->getSizeY()-12) / $this->item_height);
	...
	function addMailItem($record,$callback)
	{
