<?php
namespace ManiaLivePlugins\MLEPP\LocalRecords\Gui\Windows;

use ManiaLivePlugins\MLEPP\LocalRecords\Gui\Controls\Header;
use ManiaLivePlugins\MLEPP\LocalRecords\Gui\Controls\Normal;
...
class LocalRecsWindow extends \ManiaLive\Gui\Windowing\ManagedWindow
{
	//components ...
	private $navigator;
	private $table;
