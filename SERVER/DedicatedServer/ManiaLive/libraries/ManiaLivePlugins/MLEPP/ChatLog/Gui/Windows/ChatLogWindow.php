<?php
namespace ManiaLivePlugins\MLEPP\ChatLog\Gui\Windows;

use ManiaLivePlugins\MLEPP\ChatLog\Gui\Controls\Header;
use ManiaLivePlugins\MLEPP\ChatLog\Gui\Controls\Normal;
...
class ChatLogWindow extends \ManiaLive\Gui\Windowing\ManagedWindow
{
	//components ...
	private $navigator;
	private $table;
