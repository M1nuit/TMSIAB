<?php
namespace ManiaLivePlugins\MLEPP\Rankings\Gui\Windows;

use ManiaLivePlugins\MLEPP\Rankings\Gui\Controls\Header;
use ManiaLivePlugins\MLEPP\Rankings\Gui\Controls\Normal;
use ManiaLivePlugins\MLEPP\Rankings\Gui\Controls\Action;
...
class TopRankingsWindow extends \ManiaLive\Gui\Windowing\ManagedWindow
{
	//components ...
	private $navigator;
	private $table;
	...
	function initializeComponents()
	{
		...
		$this->setTitle('Top rankings holders');
		$this->setMaximizable();
	...
	function addActionItem($record,$callback)
	{
